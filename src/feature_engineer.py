...
class AdvancedFeatureEngineer:
    ...
    def _get_form_features(self, home_team, away_team, league):
        ...
        # Get recent matches
        home_recent = self.db.get_team_historical_data(home_team, league, 10)
        away_recent = self.db.get_team_historical_data(away_team, league, 10)
    ...
    def _get_advanced_stats(self, home_team, away_team, league):
        ...
        strength_diff = abs(features['home_win_rate'] - features['away_win_rate'])
